...
public class Ese106 {
	...
	public static void main(String[] args) throws Exception {
		...
		primo.addArticolo(new Bibita("coca30cl", 1.5, "Coca-Cola", 40, 30));
		primo.addArticolo(new Bibita("coca30cl", 1.5, "Coca-Cola", 40, 30));
		...
		try {
			cotoletta = new Panino("cotoletta", 2.5, "Panino alla cotoletta con kectchup e maionese", 100, true, true);
		...
		try {
			...
			if(e.getMessage().equals("l'articolo non può essere null "))
				System.out.println("OK");
			else
				System.out.println("ERRORE");
		}
		...
		secondo.addArticolo(new Panino("cotoletta", 2.5, "Panino alla cotoletta con kectchup e maionese", 100, false, false));
		secondo.addArticolo(new Panino("cotoletta", 2.5, "Panino alla cotoletta con kectchup e maionese", 100, false, false));
		...
		secondo.addArticolo(new Schifezza("patatine-rustiche", 1, "Patatine molto molto grasse", 200));
		try {
			quartaAINF.addOrdine(secondo);
			throw new Exception("Eccezione non lanciata");
		}
		catch(Exception e) {
			if(e.getMessage().equals("Ordine presente"))
				System.out.println("OK");
			else
				System.out.println("ERRORE");
		}
